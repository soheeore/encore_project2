...
public class VariableScopeExam {
    int globalScope=10;
    static int staticVal=7;   //인스턴스화 하지 않은 클래스에서 쓸 static한 필드 선언
    ...
    public void scopeTest2(int value) {
        int localScope=20;
        System.out.println(globalScope);
        System.out.println(localScope);   //scopeTest1에서 선언한 localScope는 작동 X
        System.out.println(value);
    ...
    public static void main(String[] args) {
        ...
        System.out.println(localScope);
        System.out.println(value);
        // 같은 클래스 내에 있으면 모두 사용 가능하나.
        // 모든 클래스는 인스턴스화 해야 사용 가능
        //'static'을 붙여주면 인스턴스화 안해도 static한 field와 method는 사용가능 함.
        //static한 매개변수를 만들어서 static한 메서드에서 사용
        System.out.println(staticVal);
// static한 메서드에서 static하지 않은 변수를 사용하기 위해 객체 생성하여 사용 
        VariableScopeExam v1 = new VariableScopeExam();
        System.out.println(v1.globalScope);
        //instance변수는 VariableScopeExam v1 생성 시, globalScope저장할 공간이 생김.
        ...
        //v2를 똑같이 만들고 각각 값을 할당.
        // globalScope는 instance를 생성할 때 생성되므로 인스턴스변수라고 함.

        v1.staticVal=50;
        v2.staticVal=100;
        System.out.println(v1.staticVal);   //100
        System.out.println(v2.staticVal);   //100
        //static한 값은 인스턴스 생성 시점이 아니며, 
        //값을 저장할 수 있는 공간이 1개라서 값을 공유함.
        System.out.println(ValableScopeExam.staticVal);
        //클래스 이름을 직접 사용 가능
